...
static int androidboot_revision;

int lge_get_board_rev_no_for_dlkm(void)
{
	return androidboot_revision;
}
EXPORT_SYMBOL(lge_get_board_rev_no_for_dlkm);

static int __init board_lge_androidboot_revision_setup (char *s)
{
	if (!strcmp(s, "0"))
		androidboot_revision = 0;
	else if (!strcmp(s, "1"))
		androidboot_revision = 1;
	else if (!strcmp(s, "2"))
		androidboot_revision = 2;
	else if (!strcmp(s, "3"))
		androidboot_revision = 3;
	else if (!strcmp(s, "4"))
		androidboot_revision = 4;
	else if (!strcmp(s, "5"))
		androidboot_revision = 5;
	else if (!strcmp(s, "6"))
		androidboot_revision = 6;
	else if (!strcmp(s, "7"))
		androidboot_revision = 7;
	else if (!strcmp(s, "8"))
		androidboot_revision = 8;
	else if (!strcmp(s, "9"))
		androidboot_revision = 9;
	else if (!strcmp(s, "10"))
		androidboot_revision = 10;
	else if (!strcmp(s, "11"))
		androidboot_revision = 11;
	else if (!strcmp(s, "12"))
		androidboot_revision = 12;
	else if (!strcmp(s, "13"))
		androidboot_revision = 13;
	else if (!strcmp(s, "14"))
		androidboot_revision = 14;
	else if (!strcmp(s, "15"))
		androidboot_revision = 15;
	else
		androidboot_revision = 16;

	pr_info("androidboot_revision : %d\n",androidboot_revision);

	return 1;
}
__setup("androidboot.revision=", board_lge_androidboot_revision_setup);
...
static int __init board_dual_display_setup(char *s)
{
	...
	else if (!strcmp(s, "4")) /*support dual screen v3*/
		lge_dual_display_support = 4;
	else
