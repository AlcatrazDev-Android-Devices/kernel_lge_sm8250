...
static bool is_cp_fused(void)
{
	...
	ret = strncmp(ftm_buf, qfuse_status_str[QFUSE_ALREADY_BLOWNED], strlen(qfuse_status_str[QFUSE_ALREADY_BLOWNED])) ? false : true;
