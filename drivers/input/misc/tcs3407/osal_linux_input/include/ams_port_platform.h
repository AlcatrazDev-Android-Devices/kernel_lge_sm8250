...
#define AMS_PORT_log(x)                 printk(KERN_DEBUG "AMS_Driver: " x)
#define AMS_PORT_log_1(x, a)            printk(KERN_DEBUG "AMS_Driver: " x, a)
#define AMS_PORT_log_2(x, a, b)         printk(KERN_DEBUG "AMS_Driver: " x, a, b)
#define AMS_PORT_log_3(x, a, b, c)      printk(KERN_DEBUG "AMS_Driver: " x, a, b, c)
#define AMS_PORT_log_4(x, a, b, c, d)   printk(KERN_DEBUG "AMS_Driver: " x, a, b, c, d)
#define AMS_PORT_log_5(x, a, b, c, d,e)   printk(KERN_DEBUG "AMS_Driver: " x, a, b, c, d,e)
#else
