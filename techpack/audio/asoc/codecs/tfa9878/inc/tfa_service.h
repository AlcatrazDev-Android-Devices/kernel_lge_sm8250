 ...
 * Functions will return immediately and do not not wait for DSP reponse.
 * @param tfa the device struct pointer
...
#define TFA7478_FAM(tfa, fieldname) \
	(((tfa->rev & 0xff) == 0x74) ? \
	TFA9874_BF_##fieldname : TFA9878_BF_##fieldname)

/* set/get bit fields to HW register*/
#define TFA7478_SET_BF(tfa, fieldname, value) \
	tfa_set_bf(tfa, TFA7478_FAM(tfa, fieldname), value)
#define TFA7478_SET_BF_VOLATILE(tfa, fieldname, value) \
	tfa_set_bf_volatile(tfa, TFA7478_FAM(tfa, fieldname), value)
#define TFA7478_GET_BF(tfa, fieldname) tfa_get_bf(tfa, TFA7478_FAM(tfa, fieldname))

/* set/get bit field in variable */
#define TFA7478_SET_BF_VALUE(tfa, fieldname, bf_value, p_reg_value) \
	tfa_set_bf_value(TFA7478_FAM(tfa, fieldname), bf_value, p_reg_value)
#define TFA7478_GET_BF_VALUE(tfa, fieldname, reg_value) \
	tfa_get_bf_value(TFA7478_FAM(tfa, fieldname), reg_value)

/* write/read registers using a bit field name
 * to determine the register address
 */
#define TFA7478_WRITE_REG(tfa, fieldname, value) \
	tfa_write_reg(tfa, TFA7478_FAM(tfa, fieldname), value)
#define TFA7478_READ_REG(tfa, fieldname) \
	tfa_read_reg(tfa, TFA7478_FAM(tfa, fieldname))
...
enum tfa98xx_error tfaGetFwApiVersion(struct tfa_device *tfa,
	unsigned char *pFirmwareVersion);
#ifdef __cplusplus
}
#endif
#endif				/* TFA_SERVICE_H */
