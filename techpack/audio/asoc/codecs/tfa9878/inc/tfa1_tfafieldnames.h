...
enum tfa1_bf_enum_list {
	...
	TFA1_BF_TDME = 0x1030,     /*!< TDMEN (duplicated)                                 */
	...
	TFA1_BF_TDMSSIZE= 0x10a4,	 /*!< TDMSAMSZ (duplicated)                              */
	...
	TFA1_BF_TDMNBCK  = 0x14c3,	 /*!< NBCK (duplicated)                                  */
...
#define TFA1_NAMETABLE struct tfa_bf_name \
tfa1_datasheet_names[] = {\
...
#define TFA1_BITNAMETABLE struct tfa_bf_name \
tfa1_bit_names[] = {\
...
#define TFA1_IRQ_NAMETABLE struct tfa_irq_name \
tfa1_irq_names[] = {\
	{0, "VDDS"},\
	{1, "PLLS"},\
	{2, "DS"},\
