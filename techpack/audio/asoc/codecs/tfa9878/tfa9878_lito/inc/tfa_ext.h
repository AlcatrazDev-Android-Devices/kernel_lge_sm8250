...
typedef int (*dsp_send_message_t)(struct tfa_device *tfa,
	int length, const char *buf);
typedef int (*dsp_read_message_t)(struct tfa_device *tfa,
	int length, unsigned char *buf);
typedef int (*dsp_write_reg_t)(struct tfa_device *tfa,
